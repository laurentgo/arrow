...
public class MemoryUtil {
  ...
  static {
    try {
      ...
      final Object unsafe = AccessController.doPrivileged(new PrivilegedAction<Object>() {
        @Override
      ...
      BYTE_ARRAY_BASE_OFFSET = (long) lookup
          .findVirtual(unsafeClazz, "arrayBaseOffset", methodType(Integer.TYPE, Class.class))
          .invoke(unsafe, byte[].class);

      // get the offset of the address field in a java.nio.Buffer object
      Field addressField = java.nio.Buffer.class.getDeclaredField("address");
      addressField.setAccessible(true);
      BYTE_BUFFER_ADDRESS_OFFSET = (long) lookup
  ...
  private static MethodHandle copyMemoryMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
        .findVirtual(unsafeClazz, "copyMemory", methodType(Void.TYPE, Long.TYPE, Long.TYPE, Long.TYPE))
        .bindTo(unsafe);
  }

  private static MethodHandle copyFromToMemoryMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    final MethodHandle copyMemoryMH = lookup
        .findVirtual(unsafeClazz, "copyMemory", 
            methodType(Void.TYPE, Object.class, Long.TYPE, Object.class, Long.TYPE, Long.TYPE))
        .bindTo(unsafe);
    return MethodHandles.explicitCastArguments(copyMemoryMH, 
        methodType(Void.TYPE, byte[].class, Long.TYPE, byte[].class, Long.TYPE, Long.TYPE));
  }

  private static MethodHandle getByteMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static MethodHandle putByteMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static MethodHandle getShortMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static MethodHandle putShortMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static MethodHandle getIntMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static MethodHandle putIntMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static MethodHandle getLongMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static MethodHandle putLongMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static MethodHandle setMemoryMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
        .findVirtual(unsafeClazz, "setMemory", methodType(Void.TYPE, Long.TYPE, Long.TYPE, Byte.TYPE))
        .bindTo(unsafe);
  }

  private static MethodHandle getIntFromByteArrayMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    final MethodHandle getIntMH = lookup
        .findVirtual(unsafeClazz, "getInt", methodType(Integer.TYPE, Object.class, Long.TYPE))
        .bindTo(unsafe);
    return MethodHandles.explicitCastArguments(getIntMH, methodType(Integer.TYPE, byte[].class, Long.TYPE));
  }

  private static MethodHandle getLongFromByteArrayMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    final MethodHandle getLongMH = lookup
        .findVirtual(unsafeClazz, "getLong", methodType(Long.TYPE, Object.class, Long.TYPE))
        .bindTo(unsafe);
    return MethodHandles.explicitCastArguments(getLongMH, methodType(Long.TYPE, byte[].class, Long.TYPE));
  }

  private static MethodHandle getLongFromByteBufferMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    final MethodHandle getLongMH = lookup
        .findVirtual(unsafeClazz, "getLong", methodType(Long.TYPE, Object.class, Long.TYPE))
        .bindTo(unsafe);
    return MethodHandles.explicitCastArguments(getLongMH, methodType(Long.TYPE, ByteBuffer.class, Long.TYPE));
  }

  private static MethodHandle allocateMemoryMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static MethodHandle freeMemoryMethod(MethodHandles.Lookup lookup, Class<?> unsafeClazz,
          Object unsafe) throws NoSuchMethodException, IllegalAccessException {
    return lookup
  ...
  private static void copyMemory(@Nullable byte[] srcBase, long srcOffset,
                                @Nullable byte[] destBase, long destOffset,
                                long bytes) {
    try {
